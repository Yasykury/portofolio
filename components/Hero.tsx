  ...
  return (
    ...
    >
      ...
      <div className="shell container-px relative z-20 flex flex-1 flex-col justify-center py-16 lg:pr-[42%]">
        <FadeIn as="div" playOnMount delay={0} duration={0.35} y={8}>
        ...
        <h1 className="mt-6 font-display text-[14vw] font-extrabold leading-[0.95] tracking-tight sm:text-[12vw] md:text-[9vw] lg:text-[6.5rem] xl:text-[7.5rem]">
          <FadeIn as="div" playOnMount delay={0.04} duration={0.35} y={16}>
            <span className="block">I make</span>
          </FadeIn>
          <FadeIn as="div" playOnMount delay={0.08} duration={0.35} y={16}>
        ...
        <FadeIn as="div" playOnMount delay={0.1} duration={0.35} y={10}>
        ...
        <FadeIn as="div" playOnMount delay={0.15} duration={0.35} y={10}>
